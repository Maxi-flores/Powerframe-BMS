...
const cardData = [
  { title: 'Analytics', description: 'Track user behavior', label: 'Insights', tabColor: '#8B5CF6' },
  { title: 'Dashboard', description: 'Centralized data view', label: 'Overview', tabColor: '#3B82F6' },
  { title: 'Collaboration', description: 'Work together seamlessly', label: 'Teamwork', tabColor: '#10B981' },
  { title: 'Automation', description: 'Streamline workflows', label: 'Efficiency', tabColor: '#F59E0B' },
  { title: 'Integration', description: 'Connect favorite tools', label: 'Connectivity', tabColor: '#EF4444' },
  { title: 'Security', description: 'Enterprise-grade protection', label: 'Protection', tabColor: '#EC4899' },
];
...
const ParticleCard: React.FC<{
  ...
  }, [animateParticles, clearAllParticles, enableTilt, enableMagnetism, clickEffect, glowColor, data]);
  ...
  return (
    <div
      ...
      style={{
        ...style,
        '--tab-color': data.tabColor,
      } as React.CSSProperties}
    >
      <div className="magic-bento-card__header">
        <div className="magic-bento-card__tab" style={{ backgroundColor: data.tabColor }}></div>
        <div className="magic-bento-card__label">{data.label}</div>
      </div>
      <div className="magic-bento-card__content">
        <h2 className="magic-bento-card__title">{data.title}</h2>
        <p className="magic-bento-card__description">{data.description}</p>
      </div>
    </div>
  );
};
